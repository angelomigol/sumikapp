 ...
 */
const PRIVATE_PATH_PREFIXES = ["/dashboard", "/update-password"];
 ...
 * @param appIndexPath - The path to redirect to when the user is signed out
...
export function useAuthChangeListener({
  ...
  }, [client.auth, pathName, appIndexPath, privatePathPrefixes, onEvent]);
}
